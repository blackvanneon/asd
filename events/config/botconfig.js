    ...
    run:async(interaction, client) => {
        ...
        if(customId.endsWith("_autenticarmercadopago")) {
            ...
            await interaction.update({
                ...
                components:[
                    ...
                    .addComponents(
                        ...
                        .setStyle(5)
                        .setURL(`https://nyxauthapi.squareweb.app/mp/${interaction.guild.id}/vendasv1`),
                        new ButtonBuilder()
                        .setCustomId(`${userid}_mercadopago`)
                        .setStyle(1)
                        .setEmoji("⬅")
            ...
            const check = setInterval(async() => {
                ...
                try {
                    const response = await axios.get(`https://nyxauthapi.squareweb.app/mp/${interaction.guild.id}/api`);
